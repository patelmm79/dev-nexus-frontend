    ...
    <Box>
      ...
      <Paper sx={{ p: 2, mb: 2 }}>
        ...
        <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <Chip
            size="small"
            label={`${componentsData?.total_components ?? 0} components, ${analyzedComponents.size} analyzed`}
            color="primary"
          />
        </Box>
      </Paper>
            ...
            {isAnalyzing && (
              ...
              >
                ...
                <Typography variant="body2">
                  Analyzing components... ({analyzedComponents.size}/{componentsData?.total_components})
                </Typography>
              </Box>
            )}
            <ForceGraph2D
